...
import IconLabel from "./index.tsx";
import './index.scss'

storiesOf("列表页组件|IconLabel", module)
  .addDecorator(withKnobs)
  .add("标签", () => {
    const labelList = ['我是标签11', {"name":'我是标签2', "id":22222}, {"name":'我是标签3', "id":3333}, {"name":'我是标签4', "id":44444}, {"name":'我是标签5', "id":5555}];
